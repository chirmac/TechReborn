...
public class BlockFissionReactorCore extends Block {
	public BlockFissionReactorCore(Settings settings) {
	...
	public void buildTooltip(ItemStack stack, @Nullable BlockView worldIn, List<Text> tooltip,
		...
		tooltip.add(new LiteralText("Place in the middle of your Fission Nuclear Reactor"));
	}
}
